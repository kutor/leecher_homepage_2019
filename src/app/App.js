...
const BandImage = () => (
  <div id="div_band_image">
    <img src="../img/index/band_img_0.png" alt="Symphonic Cello Metal Band Leecher" className="band_image"></img>
  </div>
)
...
const DivLiveSmall = props => (
  <div class="div_live_small"><a className="live_small_link" href={props.showVenueWeb} target='_blank' rel='noopener noreferrer'><span className="live_small_sub">{props.showDate}</span><span className="live_small_sub">{`${props.showCity}, ${props.showCountryAbbr}`}</span></a></div>
)
...
const DivLive = props => (
      <div className="div_liveshow">
        <div className="div_liveshow_sub">
          ...
          <div><a href={props.showVenueWeb} target='_blank' rel='noopener noreferrer'>{props.showVenue}</a></div>
        </div>
        <div className="div_liveshow_sub">
          ...
          {props.showTickets ? (
            <div className="div_liveshow_sub">
              <div><a href={props.showTickets}>Tickets</a></div>
            </div>
          ) :(null)}
